...
import com.tanghsk.util.ReflectHelper;
import com.tanghsk.util.StringTools;
...
public class PagePlugin implements Interceptor {
	...
	private String generatePageSql(String sql,Page page){
		if(page!=null && StringTools.notEmpty(dialect)){
	...
	public void setProperties(Properties p) {
		...
		if (StringTools.isEmpty(dialect)) {
			try {
		...
		if (StringTools.isEmpty(pageSqlId)) {
			try {
