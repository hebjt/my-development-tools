 ...
 *2012-1-13
 */
public final class DateUtil extends SimpleDateFormat
{
    /**
	 * 注释内容
	 */
     ...
     * DATETOOL
     */
    private static DateUtil dateTools = null;
     ...
     * @return DateTools
     */
    public static DateUtil getDateTools()
    {
        if (null == dateTools)
        {
            dateTools = new DateUtil();
        }
        return dateTools;
    }
     ...
     * @return DateTools
     */
    public static DateUtil getDateTools(String mode)
    {
        if (null == dateTools)
        {
            dateTools = new DateUtil(mode);
        }
        return dateTools;
    }
