...
<div id="outFrame">
	<div id="view">
		<div id="title">添加试卷</div>
		<form action="save_paper.action" name="form1" id="form1" method="POST" enctype="multipart/form-data">
		<table>
			<tr>
				<th>试卷名称：</th><td><input type="text" name="paperName" id="paperName" size="43"/></td>
			</tr>
			<tr>
				<th>科目名称：</th>
				<td>
			...
			<tr>
				<th>听力文件：</th>
				<td><input type="file" name="ListeningFile" id="ListeningFile" size="31"/></td>
			</tr>
			<tr>
				<th>试题数量：</th>
				<td><input type="text" name="paperQuestionNum" id="paperQuestionNum" size="43" /></td>
			</tr>
			<tr>
				<th>答题时间：</th>
				<td><input type="text" name="paperExamTime" id="paperExamTime" size="43" /></td>
			</tr>
			<tr>
				<th>注意事项：</th>
				<td>
