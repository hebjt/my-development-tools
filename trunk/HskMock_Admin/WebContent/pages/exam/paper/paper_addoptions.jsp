...
<form id="form1" name="form1" id="form1" method="post">
	<input type="hidden" name="quesId" id="quesId" value="${question.quesId}" />
	<input type="hidden" name="optPaperId" id="optPaperId" value="${question.paperId}" />
	<input type="hidden" name="optStructId" id="optStructId" value="${question.subjectStructId}" />
	<input type="hidden" name="quesTypeId" id="quesTypeId" value="${question.quesTypeId}" />
	<div id="outFrame">
	
		<div id="list">
		<div id="title" style="background-color:white; text-align:center;">新建选项</div>
				...
				<table border="0" width="100%"  cellspacing="0">
					<tr>
						...
						<td>
							<input name="optSeqNum" id="optSeqNum" />
						</td>
					</tr>
