...
<div id="outFrame">
	<div id="view">
		...
		<div id="topBar">修改学生信息</div>
		<form action="update_user.action" name="form1" method="POST">
		<table cellspacing="0" border="1">
			<tr>
				<th>ID</th><td><input type="text" name="user_id" id="user_id" value="${item.user_id}"/></td></tr>
			<tr>
			...
			<tr>
				<th>生日</th><td><input type="text" name="user_birthday" id="user_birthday" value="<fmt:formatDate value="${item.user_birthday}" type="date"/>"/> </td></tr>
			<tr>
